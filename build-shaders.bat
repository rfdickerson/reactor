...
slangc -g -O1 shaders/composite.slang -target spirv -profile vs_6_0 -entry vertexMain -o resources/shaders/composite-slang.vert.spv
slangc -g -O1 shaders/composite.slang -target spirv -profile ps_6_0 -entry fragmentMain -o resources/shaders/composite-slang.frag.spv